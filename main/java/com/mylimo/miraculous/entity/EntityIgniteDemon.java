...
public class EntityIgniteDemon extends EntityMob
{
    public EntityIgniteDemon(World world)
    {
        super(world);
    ...
    @Nullable
    protected ResourceLocation getLootTable() {return new ResourceLocation(Reference.MOD_ID, "ignite_demon");}
