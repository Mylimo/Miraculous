...
public class EntityMangleDemon extends EntityMob
{
    public EntityMangleDemon(World world)
    {
        super(world);
    ...
    @Nullable
    protected ResourceLocation getLootTable() {return new ResourceLocation(Reference.MOD_ID, "mangle_demon");}
