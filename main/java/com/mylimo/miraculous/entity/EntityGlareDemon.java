...
public class EntityGlareDemon extends EntityMob
{
    public EntityGlareDemon(World world)
    {
        super(world);
    ...
    @Nullable
    protected ResourceLocation getLootTable() {return new ResourceLocation(Reference.MOD_ID, "glare_demon");}
